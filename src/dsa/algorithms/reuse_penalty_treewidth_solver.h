...
struct TreewidthPartitionDpOptions {
  ...
  // Maximum canonical bag partitions stored for one eliminated variable.
  // This is bounded by a Bell number and is independent of unused address
  // colors. Zero disables the guard.
