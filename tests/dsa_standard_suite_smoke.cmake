...
foreach(EXPECTED "## Solution quality" "## Runtime relative to first fit" "geometric-mean peak" "MiniMalloc benchmark corpus" "--standard-only" "PyPTO")
...
if(REPORT MATCHES "\\| Overall ")
  message(FATAL_ERROR "standard-only presentation retained a redundant overall row")
endif()
