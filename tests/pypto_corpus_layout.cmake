...
if(NOT INSTANCE_COUNT EQUAL 454)
  message(FATAL_ERROR "expected 454 PyPTO instances, found ${INSTANCE_COUNT}")
endif()
...
if(NOT CORPUS_TABLE_ROW_COUNT EQUAL 455)
  message(FATAL_ERROR
    "expected a header plus 454 corpus statistics rows, found ${CORPUS_TABLE_ROW_COUNT}")
endif()
...
set(EXPECTED_COUNTS 11 165 113 161 4)
